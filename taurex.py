...
global MPIimport, MPIverbose, MPImaster, multinest_import, polychord_import
...
if polychord_import:
    logging.info('PolyChord library correctly loaded.')
else:
    logging.warning('PolyChord library is not loaded. PolyChord functionality will be disabled')

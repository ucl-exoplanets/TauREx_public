      subroutine add_tflx(nlyr,tl,rl,fup,fdn,urt,drb,
     -                    uft,dfb,ft,fb,flxu,flxd)
c
ccccccccccccccccccccccccccc  a d d _ t f l x   ccccccccccccccccccccccccc
cc                                                                    cc
cc    p u r p o s e :                                                 cc
cc                                                                    cc
cc    this program uses the layer adding method for finding thermal   cc
